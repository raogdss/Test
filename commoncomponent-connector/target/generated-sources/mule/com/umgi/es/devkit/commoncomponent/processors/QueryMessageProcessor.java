...
/**
 * QueryMessageProcessor invokes the {@link com.umgi.es.devkit.commoncomponent.CommonComponentConnector#query(java.lang.String)} method in {@link CommonComponentConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    CommonComponentConnector connector = ((CommonComponentConnector) object);
                    ...
                    if ((trimmedQuery!= null)&&(_transformedQuery).startsWith("dsql:")) {
                        ...
                        return ((CommonComponentConnector) object).query(_transformedQuery);
                    } else {
                        return ((CommonComponentConnector) object).query(_transformedQuery);
                    }
                }
    ...
    public Result<MetaData> auxOutputMetaData(MetaData inputMetadata, String key) {
        if (((key) == null)||((key).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: key at processor query at module CommonComponentConnector");
        }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CommonComponentConnector at query retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
